...
<section class="content">
    ...
    <form class="search-form-2" id="rank_search" action="{{route('student.index')}}"
                                ...
                                <tr>
                                    ...
                                    <td>
                                         @if(!empty(optional($data->payment)->payment_id))    
                                            ...
                                            <b>Date: </b>{{optional($data->payment)->created_at}}
                                        @else 
                                            Not Subscribed 
                                        @endif
                                        <br> 
                                        <label class="switch">
                                            <input type="checkbox" class="tog"  name="my-checkbox" value="{{$data->id}}"   @if(!empty(optional($data->payment)->payment_id))    checked    @endif  >
