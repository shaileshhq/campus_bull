                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group mt-3 ">
                                    ...
                                    <input type="number" class="form-control" name="rank" id="rank" placeholder="Enter Rank" value="{{Auth::user()->customer->rank}}" @if(Auth::user()->id!=13){{'disabled'}}@endif  required/>   
